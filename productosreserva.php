        ...
        <div id="barraLogin">
          <ul id="listaLogin">
            ...
            <div class="centrado">
                ...
                $sql="INSERT INTO `tbl_reservas`(`id_usuari`, `hora_entrada`, `id_material`) VALUES ($_SESSION[login_user], NOW(), $_REQUEST[id_material])";
                $sql2="UPDATE tbl_material SET disponible= 1 WHERE id_material= $_REQUEST[id_material]";
                //echo $sql2;
                $datos=mysqli_query($con,$sql);
                $datos1=mysqli_query($con,$sql2);
